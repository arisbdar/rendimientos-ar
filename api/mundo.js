...
const SYMBOLS = [
  ...
  // BTC Treasury — Top 10 public companies by BTC holdings (source: bitcointreasuries.net)
  { id: 'mstr', symbol: 'MSTR', name: 'Strategy', icon: '₿', group: 'BTC Treasury' },
  { id: 'xxi', symbol: 'XXI', name: 'Twenty One', icon: '₿', group: 'BTC Treasury' },
  { id: 'metaplanet', symbol: 'MPJPY', name: 'Metaplanet', icon: '₿', group: 'BTC Treasury' },
  { id: 'mara', symbol: 'MARA', name: 'MARA Holdings', icon: '₿', group: 'BTC Treasury' },
  { id: 'cepo', symbol: 'CEPO', name: 'BTC Standard', icon: '₿', group: 'BTC Treasury' },
  { id: 'blsh', symbol: 'BLSH', name: 'Bullish', icon: '₿', group: 'BTC Treasury' },
  { id: 'riot', symbol: 'RIOT', name: 'Riot Platforms', icon: '₿', group: 'BTC Treasury' },
  { id: 'coin', symbol: 'COIN', name: 'Coinbase', icon: '₿', group: 'BTC Treasury' },
  { id: 'asst', symbol: 'ASST', name: 'Strive', icon: '₿', group: 'BTC Treasury' },
